...
export default function OuvrierComponents() {
    const operateur = {}; // Define 'operateur' as an empty object or with appropriate properties
    ...
    const defaultOperateur = {
        ...
        niveau: "Expert",
        statut: "disponible", // disponible, occupe, pause
        tacheActuelle: null,
        heuresJour: 6.5,
        heuresMax: 8, // Add the 'heuresMax' property with a default value
        ...operateur, // Ensure 'operateur' is defined above
      ...
      const getNiveauColor = (niveau: any) => {
        switch(niveau) {
